...
public class Android_FriendsTest extends AndroidElements {
    ...
    public void test03_block_all_accounts() throws Exception {
    	...
    	// Send friends_account02 blast before blocking
    	blasts_tab();
    	action_menu().click();
    	Thread.sleep(500);
    	...
    	// Send friends_account02 dust before blocking
    	blasts_tab();
    	action_menu().click();
    	Thread.sleep(500);
    	...
    	// Block friends_account03 from inside dust room
    	...
    	// Block friends_account02 from Dusts tab
    	...
    	// Block friends_account05 from swipe view
    	...
    	// Block friends_account04 from Blasts Tab
    ...
    public void test04_message_to_blocked() throws Exception {
    	...
    	for (int i = 2; i <= 6; i++){
	    	try {
	    		waitTime(1);
	    		name(friends_account01.substring(0, 11)+i).click();
    ...
    public void test05_mute_all_accounts() throws Exception {
    	...
    	// Mute friends_account01 from Dusts tab
    	...
    	// Mute friends_account05 from swipe view
    	...
    	// Mute friends_account06 from More / Friends
    	Thread.sleep(1000);
    	more_button().click();
    ...
    public void test06_dusts_and_blasts_02() throws Exception {
    	// Send dust to friends_account01
    	blasts_tab();
    	action_menu().click();
    	Thread.sleep(500);
    	...
    	// Send blast to friends_account01
    	blasts_tab();
    	action_menu().click();
    	Thread.sleep(500);
    ...
    public void test12_check_msg_from_blocked() throws Exception {
    	loginAs.user(friends_account01, friends_password01);
    	for (int i = 2; i <= 6; i++) {
	    	checkForBlastsFrom(friends_account01.substring(0, 11)+i);
	    	checkForDustsFrom(friends_account01.substring(0, 11)+i);
    	}
    }
    ...
    public void test15_unmute_account01() throws Exception {
    	...
    	// Unmute friends_account01 from swipe view
    ...
    public void test18_add_accounts() throws Exception {
    	...
    	name(friends_account05).click();
    	name(friends_account06).click();
    	name(friends_account04).click();
